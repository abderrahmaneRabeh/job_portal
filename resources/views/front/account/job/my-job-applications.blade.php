                            ...
                            <table class="table ">
                                ...
                                <tbody class="border-0">
                                    ...
                                    <tr class="active">
                                        ...
                                        <td>{{ $jobApplication->job->created_at->format('d/m/Y') }}</td>
                                            ...
                                            <div class="action-dots float-end">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('jobDetails', $jobApplication->job_id) }}">
                                                    ...
                                                    {{-- <li><a class="dropdown-item"
                                                            ...
                                                            Edit</a></li> --}}
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('account.deleteJobApplication', $jobApplication->id) }}"><i
                                    ...
                                    @else
                                    <tr>
                                        <td colspan="5" class="text-center">No Job Application Found</td>
                                    </tr>
                                    @endif
                                </tbody>
