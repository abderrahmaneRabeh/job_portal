                ...
                <div class="col-md-4 col-lg-3 sidebar mb-4">
                    <form action="" name="searchForm" id="searchForm">
                        <div class="card border-0 shadow p-4">
                            <div class="mb-4">
                                <h2>Keywords</h2>
                                <input value="{{ Request::get('keyword') }}" name="keyword" id="keyword" type="text"
                                ...
                                @if ($jobtype->isNotEmpty())
                                    @foreach ($jobtype as $type)
                                        <div class="form-check mb-2">
                                            <input {{ in_array($type->id, $jobTypeArray) ? 'checked' : '' }}
                                                class="form-check-input " name="jobType" type="checkbox"
                                                value="{{ $type->id }}" id="jobType-{{ $type->id }}">
                                            <label class="form-check-label "
                                                for="jobType-{{ $type->id }}">{{ $type->name }}</label>
                                        </div>
                                    @endforeach
                                @endif
                            </div>
